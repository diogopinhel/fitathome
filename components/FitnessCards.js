...
const FitnessCards = () => {
    ...
    <View style={{marginTop:60}}> 
        ...
        <Pressable onPress={()=> navigation.navigate("WorkoutScreen",{image:item.image, exercises:item.exercises, id:item.id,})} style={{alignItems:"center", justifyContent:"center", margin:10}} key={key}>
