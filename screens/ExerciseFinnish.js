...
(parseInt(value) || 0);
  ...
  return (
    ...
    <View style={{backgroundColor:"#2E9AFE"}}>
       ...
       <Text style={{color:"#FFFFFF",marginLeft:255, marginRight:"auto", fontSize:18,marginTop:70}}>Planos</Text>
       <Text style={{color:"#FFFFFF",marginLeft:283, marginRight:"auto", fontSize:18,top:20}}>{countPlans}</Text>
       <Text style={{color:"#FFFFFF",marginLeft:"auto", marginRight:245, fontSize:18,marginTop:-49}}>Exercicios</Text>
       <Text style={{color:"#FFFFFF",marginLeft:"auto", marginRight:280, fontSize:18,top:20}}>{countExercises}</Text>
